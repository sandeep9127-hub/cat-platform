export function SectionHead({
  ...
  return (
    <div className="max-w-page mx-auto mt-16 lg:mt-20 mb-7 px-5 sm:px-7 lg:px-10 flex items-baseline gap-4 sm:gap-7 flex-wrap">
      ...
      <span className="flex-1 h-px bg-line mt-[16px] sm:mt-[22px] hidden sm:block" />
      {meta && (
