        ...
        <div className="order-2 lg:order-none pb-10">
          ...
          >
            ...
            <a
              ...
              download
              className="group mt-7 inline-flex w-fit items-center gap-2 rounded-full bg-deep-teal text-paper px-6 py-3 text-[14px] font-medium hover:bg-teal active:scale-[0.97] transition-[transform,background-color] duration-200 ease-out-expo"
            >
