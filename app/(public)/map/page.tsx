...
export const metadata = {
  ...
  description:
    "Every food-systems programme and intervention published on the platform, plotted on India. The open library, complementary to CAT's eleven focus landscapes.",
};
      ...
      <section className="max-w-page mx-auto px-5 sm:px-7 lg:px-10 pt-12 sm:pt-16 lg:pt-20 pb-8 grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-10 lg:gap-16 items-end">
        <div className="reveal-stagger" style={{ animationDelay: "0ms" }}>
          ...
          <p className="font-serif italic text-[17px] sm:text-[19px] text-ink-soft leading-[1.45] max-w-[48ch] mt-6 font-light">
            Every food-systems programme and intervention published on the platform, plotted
            on India. Each dot is a programme at the scale we have published it. Teal is
            self-submitted; amber is CAT-sourced. This is the open library, complementary to
            CAT&apos;s eleven{" "}
