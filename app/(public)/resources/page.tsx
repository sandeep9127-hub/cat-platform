        ...
        {resources.length === 0 ? (
          <div className="mt-10 max-w-[52ch] py-8 px-6 rounded-[8px] border border-line bg-paper">
            ...
            <p className="font-sans text-[16px] text-ink leading-[1.55] mt-3">
              No resources match{" "}
              {typeFilter && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-[3px] mx-1 text-[14px]" style={{ background: "rgba(46,117,115,0.10)", color: "#2E7573" }}>
                  type: {TYPE_META[typeFilter].label}
                </span>
              )}
              {typeFilter && themeFilter && " and "}
              {themeFilter && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-[3px] mx-1 text-[14px]" style={{ background: "rgba(146,156,197,0.14)", color: "#5C6796" }}>
